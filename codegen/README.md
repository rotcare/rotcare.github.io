...
然而我们在把业务逻辑拆分成多个 Git 仓库来编写的时候，就遇到了代码如何粘合回来的问题。

* 主板和插件怎么粘合到一起？
* 顶层的那个项目只起到聚合代码的作用，那是不是可以代码生成出来？

`@rotcare/codegen` 所演示的能力，就是利用编译期的工具，在 TypeScript => JavaScript 的过程中，把拆分的代码文件粘合回一个文件。这种粘合代码的方式，是在所有限制管控依赖关系的技术里，实现代价最低的方案。
